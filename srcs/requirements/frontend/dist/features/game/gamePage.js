...
function updateHUD(leftCharacter, rightCharacter) {
    const leftCharHUD = document.getElementById('left-character-hud');
    if (leftCharHUD)
        leftCharHUD.classList.toggle('hidden');
    const leftPortrait = document.getElementById('left-character-portrait');
    if (leftPortrait)
        leftPortrait.src = leftCharacter?.characterAvatarPicturePath;
    ...
    if (rightCharHUD)
        rightCharHUD.classList.toggle('hidden');
    const rightPortrait = document.getElementById('right-character-portrait');
    if (rightPortrait)
        rightPortrait.src = rightCharacter?.characterAvatarPicturePath;
