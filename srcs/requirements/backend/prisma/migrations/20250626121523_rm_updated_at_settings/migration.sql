/*
  ...
  - You are about to drop the column `settings` on the `Match` table. All the data in the column will be lost.
...
INSERT INTO "new_Match" ("createdAt", "id", "mode", "stats", "user1Alias", "user1Character", "user1Id", "user1Score", "user2Alias", "user2Character", "user2Id", "user2Score", "winnerId") SELECT "createdAt", "id", "mode", "stats", "user1Alias", "user1Character", "user1Id", "user1Score", "user2Alias", "user2Character", "user2Id", "user2Score", "winnerId" FROM "Match";
DROP TABLE "Match";
