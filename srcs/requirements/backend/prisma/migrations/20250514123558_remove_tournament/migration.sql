...
INSERT INTO "new_Match" ("createdAt", "duration", "id", "mode", "settings", "updatedAt", "user1Character", "user1Id", "user1Score", "user2Character", "user2Id", "user2Score", "winnerId") SELECT "createdAt", "duration", "id", "mode", "settings", "updatedAt", "user1Character", "user1Id", "user1Score", "user2Character", "user2Id", "user2Score", "winnerId" FROM "Match";
DROP TABLE "Match";
...
INSERT INTO "new_TournamentParticipant" ("id", "tournamentId", "userId") SELECT "id", "tournamentId", "userId" FROM "TournamentParticipant";
